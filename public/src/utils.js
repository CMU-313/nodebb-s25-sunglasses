...
utils.makeNumbersHumanReadable = function (elements) {
	console.warn(
		"[deprecated] utils.makeNumbersHumanReadable is deprecated! Use {humanReadableNumber(value)} helper directly in the template",
	);
...
utils.addCommasToNumbers = function (elements) {
	console.warn(
		"[deprecated] utils.addCommasToNumbers is deprecated! Use {formattedNumber(value)} helper directly in the template",
	);
